    ...
    <div className="max-w-7xl mx-auto px-6 relative z-10">
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12">
        ...
        >
          ...
          <button className="w-full bg-white text-black py-5 font-mono text-[10px] md:text-xs font-black uppercase tracking-[0.2em] hover:bg-amber-500 hover:text-black transition-all shadow-[0_5px_20px_rgba(255,255,255,0.1)] hover:shadow-[0_5px_30px_rgba(245,158,11,0.3)] rounded-sm">
        ...
        >
          ...
          <button className="w-full bg-transparent border border-white/20 text-white py-5 font-mono text-[10px] md:text-xs font-black uppercase tracking-[0.2em] hover:border-amber-500 hover:bg-amber-500/10 hover:text-amber-500 transition-all rounded-sm">
